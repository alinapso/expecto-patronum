...
export const FormNavButton = ({ id, buttonIcon, text, Active = false, onClick }: any) => {
	return (
		<Button className={` ${Active ? "active done" : ""} btn nav-link`} onClick={() => onClick(id)} role="tab">
								...
								<Form method="post" id="registration">
									<Nav fill variant="pills" className="stepwizard-row" id="nav-tab" role="tablist">
										<FormNavButton
											...
											onClick={AccountShow}></FormNavButton>
										<FormNavButton
											id="document-detail"
											buttonIcon="ri-lock-unlock-line bg-soft-primary text-primary"
									...
									<TabContent className="pt-4 pb-2" id="nav-tabContent">
										<TabPane
											className={` ${show === "user-detail" ? "d-block" : "d-none"} fade row show`}
											id="user-detail">
											<Col sm="12">
												<Col md="12" className="p-0">
													...
													<Row>
														<Form.Group className=" col-md-6 form-group">
															...
															<Form.Control type="text" required={true} placeholder="Enter First Name" />
														</Form.Group>
														<Form.Group className=" col-md-6 form-group">
															<Form.Label>Last Name</Form.Label>
															<Form.Control type="text" required={true} placeholder="Enter Last Name" />
														</Form.Group>
														<Form.Group className="col-md-6 form-group ">
										...
										<TabPane
											className={` ${show === "document-detail" ? "d-block" : "d-none"} row show fade`}
											id="document-detail">
											<Col sm="12">
												<Col md="12" className="p-0">
													...
													<Row>
														...
														<Form.Group className="form-group col-md-12">
															...
															<Form.Control as="textarea" name="cadd" required={true} id="cadd" rows={5}></Form.Control>
														</Form.Group>
													</Row>
													<Button
														variant="secondary"
										...
										<TabPane
											className={` ${show === "bank-detail" ? "d-block" : "d-none"} row show fade`}
											id="bank-detail">
											<Col sm="12">
												<Col md="12" className="p-0">
										...
										<TabPane
											className={` ${show === "cpnfirm-data" ? "d-block" : "d-none"} row show fade`}
											id="cpnfirm-data">
											<Col sm="12">
												<Col md="12" className="p-0">
													...
													<Row className="justify-content-center">
														<div className="col-3">
															<Image src={image1.src} className="img-fluid" alt="img-success" />
														</div>
													</Row>
												</Col>
											</Col>
